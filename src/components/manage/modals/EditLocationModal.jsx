...
export default function EditLocationModal({
    ...
    if (!openEditLocation || !location) return null;
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            onClick={() => setOpenEditLocation(null)}
        >
            <motion.div
            ...
            >
                <h2 className="text-xl font-bold text-foreground mb-4">Edit Location</h2>
